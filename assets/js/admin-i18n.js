(function () {
  ...
  const copy = {
    ...
    "Sign Out": { ko: "로그아웃" },
    "Password": { ko: "비밀번호" },
    "Change Password": { ko: "비밀번호 변경" },
    "Change My Password": { ko: "내 비밀번호 변경" },
    "Create Your Password": { ko: "새 비밀번호 설정" },
    "Current Password": { ko: "현재 비밀번호" },
    "New Password": { ko: "새 비밀번호" },
    "Confirm New Password": { ko: "새 비밀번호 확인" },
    "Save New Password": { ko: "새 비밀번호 저장" },
    "Cancel": { ko: "취소" },
    "Enter your current password and choose a new password.": { ko: "현재 비밀번호를 확인한 뒤 새 비밀번호를 설정하세요." },
    "This account is using a temporary password. Set a new password before continuing.": { ko: "현재 임시 비밀번호를 사용하고 있습니다. 계속하려면 새 비밀번호를 설정하세요." },
    "Confirm your current password, then choose a new password.": { ko: "현재 비밀번호를 확인한 뒤 새 비밀번호를 설정하세요." },
    "Temporary Password": { ko: "임시 비밀번호" },
    "Temporary password": { ko: "임시 비밀번호" },
    "Reset Password": { ko: "비밀번호 리셋" },
    "Current account": { ko: "현재 계정" },
    "Password change required": { ko: "비밀번호 변경 필요" },
    "Password set": { ko: "비밀번호 설정 완료" },
    "Active": { ko: "활성" },
    "Revoked": { ko: "권한 해제" },
    "Refresh": { ko: "새로고침" },
